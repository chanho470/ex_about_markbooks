...
import static com.example.markbooks.FirebaseID.documentId;
import static com.example.markbooks.FirebaseID.post;
...
import com.example.markbooks.models.Post;
import com.example.markbooks.models.PostAdapter;
    ...
    public void onItemLongClick(View view, int position) {
        ...
        dialog.setPositiveButton("삭제", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                mStore.collection(post).document(mDatas.get(position).getDocumentId()).delete();
