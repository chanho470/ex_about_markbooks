...
import com.example.markbooks.post.FirebaseID;
...
public class BookInfoActivity extends AppCompatActivity implements TextPlayer, View.OnClickListener {
        ...
        docRef.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot ds) {    //ds: documentSnapshot
                ...
                button_favorite.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                    ...
                    {
                        compoundButton.startAnimation(scaleAnimation);  //토글버튼 애니메이션효과
                        like_count++;
                        Map<String, Object> userid = new HashMap<>();
                        userid.put("like_user", userID);
                        if (like_count % 2 == 1)
            ...
            switch (item.getItemId()) {
                case R.id.highlight:
                    ...
                    if (b) {
                        ...
                        hl.put("time", FieldValue.serverTimestamp());
                        Toast.makeText(BookInfoActivity.this, "저장되었습니다.", Toast.LENGTH_SHORT).show();
    ...
    public void clickButton(View view){
        ...
        overridePendingTransition(R.anim.slide_left_enter, R.anim.slide_left_exit); // 화면 전환 효과
