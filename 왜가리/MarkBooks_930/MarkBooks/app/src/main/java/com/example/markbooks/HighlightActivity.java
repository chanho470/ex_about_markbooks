...
public class HighlightActivity extends AppCompatActivity implements RecyclerViewItemClickListner.OnItemClickListener {
    ...
    public void onItemLongClick(View view, int position) {
        //String id = mDatas.get(position).getDocumentId();
        //mStore.collection("post").document(id).delete();
        AlertDialog.Builder dialog = new AlertDialog.Builder(this);
        dialog.setMessage("삭제 하시겠습니까?");
        dialog.setPositiveButton("삭제", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                fStore.collection("user").document(adapter.getItem(position).getTitle()).delete();
                Toast.makeText(HighlightActivity.this, "삭제 되었습니다.", Toast.LENGTH_SHORT).show();
            }
        }).setNegativeButton("취소", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(HighlightActivity.this, "취소 되었습니다", Toast.LENGTH_SHORT).show();
            }
        });
